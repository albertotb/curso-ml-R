...
* Por tanto, $p(x_i, x_j| x_{\setminus {i,j}}) = p(x_i| x_{\setminus {i,j}})p(x_j| x_{\setminus {i,j}})$.
...
\begin{equation}
p(x) = \frac{1}{Z} \psi_{1,2}(x_1, x_2)  \psi_{2,3}(x_3, x_3) \cdots \psi_{N-1,N}(x_{N-1}, x_N)
\end{equation}
...
\begin{align}
p(x_n) &= \left[  \sum_{x_{n-1}} \psi_{n-1,n}(x_{n-1}, x_n) \cdots \left[ \sum_{x_1} \psi_{x_1, x_2} (x_1, x_2) \right] \cdots \right] \\
...
\begin{align}
p(x) &= \left[  \sum_{x_{n-1}} \psi_{n-1,n}(x_{n-1}, x_n) \cdots \left[ \sum_{x_1} \psi_{x_1, x_2} (x_1, x_2) \right] \cdots \right] \\
&\left[  \sum_{x_{n+1}} \psi_{n,n+1}(x_{n}, x_{n+1}) \cdots \left[  \sum_{x_{N}} \psi_{N-1,N}(x_{N-1}, x_N) \right] \cdots \right]
\end{align}
