...
Especifica un número máximo de iteraciones de 20, y pesos iniciales iguales para cada componente

```{r }
wait2 <- normalmixEM(waiting, lambda = 1, k=2, maxit = 20)
wait3 <- normalmixEM(waiting, lambda = 1, k=3, maxit = 20)
```
