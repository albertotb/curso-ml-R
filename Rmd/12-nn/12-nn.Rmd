...
* Para clasificación binaria **multiclase**, usamos una red con $K$ outputs sigmoidales. 
...
* Una revisión de los diferentes optimizadores puede encontrarse en <a href="http://ruder.io/optimizing-gradient-descent/index.html#rmsprop"> aquí /a>.
...
* Evaluamos la derivada de $E_n$ respecto $w_ji$
...
---
class: middle, center, inverse
# Perceptrón muilticapa. Regularización
...
* Permiten la selección directa de **hiperparámetros**, sin necesida de validación.
