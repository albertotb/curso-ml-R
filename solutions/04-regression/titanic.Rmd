...
Con el conjunto de datos anterior:
  ...
  7. Ajustar un modelo regresión logística regularizada 
  8. ¿Cuál es el valor de $\lambda$ óptimo?
  9. ¿Qué variables selecciona el modelo?
  10. Calcular los *odds ratio* e interpretarlos
