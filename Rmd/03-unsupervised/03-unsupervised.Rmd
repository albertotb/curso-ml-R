...
* Dado $\boldsymbol{x} \in \mathbb{R}^D$, una **aplicación (función) lineal**  $f : \mathbb{R}^N \rightarrow \mathbb{R}^M$ se expresa como
$$
...
y que
$$
\frac{\partial \boldsymbol{A} \boldsymbol{B}}{\partial \boldsymbol{x}} = \frac{\partial \boldsymbol{A}}{\partial \boldsymbol{x}}\boldsymbol{B} + \frac{\partial \boldsymbol{B}}{\partial \boldsymbol{x}}\boldsymbol{A}.
$$
...
* tSNE: en lugar de Gaussiana usamos t-Student en el espacio $\mathcal{Y}$:
